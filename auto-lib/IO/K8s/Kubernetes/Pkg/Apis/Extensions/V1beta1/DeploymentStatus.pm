package IO::K8s::Kubernetes::Pkg::Apis::Extensions::V1beta1::DeploymentStatus;
  use Moose;

  has 'replicas' => (is => 'ro', isa => 'Int'  );
  has 'unavailableReplicas' => (is => 'ro', isa => 'Int'  );
  has 'conditions' => (is => 'ro', isa => 'ArrayRef[IO::K8s::Api::Extensions::V1beta1::DeploymentCondition]'  );
